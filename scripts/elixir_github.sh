...
function upload_build {
  ...
  aws s3 cp builds.txt s3://s3.hex.pm/builds/elixir/builds.txt --cache-control "public,max-age=3600" --metadata '{"surrogate-key":"elixir-builds","surrogate-control":"public,max-age=604800"}'
